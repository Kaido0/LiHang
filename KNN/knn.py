...
if __name__ == '__main__':
    ...
    #(42000, 324)  9(9block,img)*4(4cell,1block)*9(1cell,9features)
    #
    # 选取 2/3 数据作为训练集， 1/3 数据作为测试集
    train_features, test_features, train_labels, test_labels = train_test_split(features, labels, test_size=0.1, random_state=23323)
